...
Below are some notes on how to build Yacoin Core for Windows.
...
way. This will install to `c:\workspace\yacoin`, for example:

    make install DESTDIR=/mnt/c/workspace/yacoin
